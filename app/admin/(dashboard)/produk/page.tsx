        ...
        <SlideIn>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              ...
              className="flex items-center gap-2 bg-[#341452] hover:bg-[#4b2c69] text-white px-4 py-2.5 rounded-xl text-sm font-medium transition-all shadow-lg shadow-violet-200/50 hover:shadow-violet-300/50"
            >
